...
print('\nNaive Bayes')
print('Accuracy Score withod cross fold validation: ',metrics.accuracy_score(y_test,y_pred)*100,'%',sep='')
...
print('Accuracy Score without Hyperparameter tuning : ',metrics.accuracy_score(y_test,y_pred)*100,'%',sep='')
print('Confusion Matrix: ',metrics.confusion_matrix(y_test,y_pred), sep = '\n')
